...
export default function TrainingProgramsTable({ programs, clientId }: TrainingProgramsTableProps) {
  const router = useRouter()

  const handleRowClick = (programId: string) => {
    router.push(`/coach/clients/${clientId}/training/programs/${programId}`)
  }
